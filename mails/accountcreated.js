  ...
  mail(user) {
    ...
    <html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" style="font-family:Montserrat, sans-serif"> 
     <head> 
      ...
      <title>Your WorXconnect Account Has Successfully Been Created</title><!--[if (mso 16)]>
        <style type="text/css">
                   ...
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr> 
                      <td align="center" valign="top" style="padding:0;Margin:0;width:660px"> 
                       <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                         <tr> 
                          <td align="left" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Montserrat, sans-serif;line-height:21px;color:#333333;font-size:14px">Hi ${user.fullname}</p><br><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Montserrat, sans-serif;line-height:21px;color:#333333;font-size:14px">Thank you for signing up on WorXConnect.  Please confirm your email by clicking the button below and entering the confirmation code <strong>${user.confirmationCode}</strong></p><br><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Montserrat, sans-serif;line-height:21px;color:#333333;font-size:14px">Please verify your email and get started.</p></td> 
                         </tr> 
                         <tr>
                         <a href="${process.env.FRONTEND_URL}/confirm-email?email=${user.email}&code=${user.confirmationCode}"> 
                          <td align="center" style="padding:0;Margin:0;padding-top:15px"><span class="es-button-border" style="border-style:solid;border-color:#2CB543 #2CB543 #A32E00 #A32E00;background:#4d5c6a;border-width:0px 0px 4px 4px;display:block;border-radius:10px;width:auto;border-left-color:#45bda0;border-bottom-color:#45bda0;border-left-width:2px;border-bottom-width:2px;border-right-width:2px;border-right-color:#45bda0"><a href="" class="es-button es-button-1" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;border-style:solid;border-color:#4d5c6a;border-width:15px 5px;display:block;background:#4d5c6a;border-radius:10px;font-family:Montserrat, sans-serif;font-weight:bold;font-style:normal;line-height:22px;width:auto;text-align:center">Verify Email</a></span></td> 
                         </tr></a>
                       </table></td> 
                     </tr> 
                   </table></td> 
