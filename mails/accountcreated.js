                                ...
                                <tr>
                                  <td class="mcnImageContent" valign="top" style="padding-right: 0px; padding-left:
                                    ...
                                    <img align="center" alt=""
                                      src="https://mcusercontent.com/ce45edeb344ebeff0bb5aad06/images/2568cd88-b7a7-3f58-04eb-8c93fa0e374a.png"
                                      width="600"
                                  ...
                                  <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px;
                                    ...
                                    <div style="width:570px;">
                                      <a href="${process.env.FRONTEND_URL}/confirm-email?email=${user.email}&code=${user.confirmationCode}"
                                        style="background-color:#2bbdb9;border:1px solid #2bbdb9;border-radius:5px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:16px;font-weight:bold;line-height:50px;text-align:center;text-decoration:none;width:100%;-webkit-text-size-adjust:none;mso-hide:all;">Confirm
                                        Email</a>
