...
module.exports = class SendQuote {
  ...
  mail(user, candidateList) {
    ...
    <head>
      ...
      <title>Quote for your selected candidate</title>
    ...
    <body style="color: #000000;">
      <span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px;
            max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">Quote for your selected candidate</span>
      <center>
