...
module.exports = class ResetPassword {
  ...
  mail(user) {
    ...
    <head>
      ...
      <title>Your Password Has Successfully Been Reset</title>
    ...
    <body style="color: #000000;">
      <span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px;
            max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">Your Password Has Successfully Been Reset</span>
      <center>
